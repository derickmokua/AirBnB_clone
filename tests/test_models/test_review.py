...
class TestReview_instantiation(unittest.TestCase):
    """Unit tests to verify the instantiation of the Review class."""
...
class TestReview_save(unittest.TestCase):
    """Unit tests to evaluate the save method of the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unit tests to assess the to_dict method of the Review class."""
