...
class TestCity_instantiation(unittest.TestCase):
   """Unit tests to verify the instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unit tests to evaluate the save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unit tests to assess the to_dict method of the City class."""
