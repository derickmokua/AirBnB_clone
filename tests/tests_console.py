...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for validating prompting in the HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for validating help messages in the HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for validating 'exit' functionality in the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for validating 'create' functionality in the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for validating 'show' functionality in the HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for checking destroy functionality in HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests for validating 'all' functionality in the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for validating 'update' functionality in the HBNB command interpreter."""
    ...
    def test_update_missing_attr_name_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch(:Q"sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            testId = output.getvalue().strip()
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for validating 'count' method in the HBNB command interpreter."""
