...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        """Usage: create <class>
        Creates a new class instance and prints id.
        """
        argl = parse(arg)
        if len(argl) == 0:
    ...
    def do_show(self, arg):
        ...
        Displays the string representation of a class instance of an id.
        """
        argl = parse(arg)
        objdict = storage.all()
        if len(argl) == 0:
    ...
    def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        Updats a class instance of a particular id by adding/updating
